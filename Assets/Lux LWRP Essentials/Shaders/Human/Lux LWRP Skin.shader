    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 LitPassFragment(VertexOutput input) : SV_Target
            {
                ...
                //  Apply lighting
                half4 color = LuxLWRPSkinFragmentPBR(inputData, surfaceData.albedo, surfaceData.metallic, surfaceData.specular, surfaceData.smoothness, surfaceData.occlusion, surfaceData.emission, surfaceData.alpha,
                half4(_TranslucencyStrength * surfaceData.translucency, _TranslucencyPower, _ShadowStrength, _Distortion), 1, normalWS, _SubsurfaceColor,
                lerp(surfaceData.translucency, 1, _Curvature), surfaceData.skinMask);
