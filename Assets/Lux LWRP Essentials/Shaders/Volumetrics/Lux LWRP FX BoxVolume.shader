    ...
    SubShader
    {
        ...
        //  Helper functions to handle orthographic / perspective projection  
            ...
            half4 frag (VertexOutput input ) : SV_Target
            {
                ...
                float3 viewDirWS = SafeNormalize(input.positionWS - _WorldSpaceCameraPos);
            ...
            //  Convert linear eye depth to distance in world space
                ...
                float sceneDistance = sceneZ / dot(-viewDirWS, cameraForward);
            ...
            //  Entry point in world space
                float3 entry = mul(GetObjectToWorldMatrix(), float4(rayStart + rayDir * near, 1)).xyz;
            ...
            //  Exit point in world space.
                float3 exit = mul(GetObjectToWorldMatrix(), float4(rayStart + rayDir * far, 1)).xyz;
