Shader "Lux LWRP/Terrain/Lit"
{
    ...
    Dependency "AddPassShader" = "Hidden/Lux LWRP/Lit (Add Pass)"
    Dependency "BaseMapShader" = "Lux LWRP/Terrain/Lit (Base Pass)"
    Dependency "BaseMapGenShader" = "Hidden/Lux LWRP/Terrain/Lit (Basemap Gen)"
