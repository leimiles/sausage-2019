Shader "Lux LWRP/Lit Extended Uber"
{
    Properties
    {
...
//                #undef _ALPHATEST_ON
            ...
            #include "Includes/Lux LWRP Uber Lit Pass.hlsl"

            #include "Includes/Lux LWRP Lit Extended Lighting.hlsl"



            half4 LitPassFragmentRim(Varyings input, half facing : VFACE) : SV_Target
            {
